...
public class Main {
    public static void main(String[] args) {
        ...
        Produkt alcohol4 = new Produkt("Whiskey", "Fine aged Scotch", 150, 43, 3_10_2025, "isAlcoholic");
        Produkt product5 = new Produkt("Pepsi", "Beverage", 9, 43, 6_7_1998, "isAlcoholic");
